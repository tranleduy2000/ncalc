 ...
 *
 */
package com.duy.ncalc.geom2d.polygon;
...
import com.duy.ncalc.geom2d.curve.ContinuousCurve2D;
...
public abstract class LinearCurve2D implements ContinuousCurve2D {
     ...
     */
    public abstract com.duy.ncalc.geom2d.line.LineSegment2D edge(int index);
     ...
     */
    public abstract Collection<com.duy.ncalc.geom2d.line.LineSegment2D> edges();

    public com.duy.ncalc.geom2d.line.LineSegment2D firstEdge() {
        if (vertices.size() < 2)
            return null;
        return new com.duy.ncalc.geom2d.line.LineSegment2D(vertices.get(0), vertices.get(1));
    }

    public abstract com.duy.ncalc.geom2d.line.LineSegment2D lastEdge();
    ...
    public double length() {
        double sum = 0;
        for (com.duy.ncalc.geom2d.line.LineSegment2D edge : this.edges())
            sum += edge.length();
        return sum;
    }
    ...
    public double position(double length) {
        ...
        for (com.duy.ncalc.geom2d.line.LineSegment2D edge : edges()) {
    ...
    public boolean isInside(Point2D point) {
        ...
        int winding = com.duy.ncalc.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        if (area > 0) {
            return winding == 1;
        } else {
            return winding == 0;
     ...
     */
    public Collection<? extends com.duy.ncalc.geom2d.line.LineSegment2D> smoothPieces() {
        return edges();
    }
    ...
    public double position(Point2D point) {
        ...
        int i = 0;
        com.duy.ncalc.geom2d.line.LineSegment2D closest = null;
        for (com.duy.ncalc.geom2d.line.LineSegment2D edge : this.edges()) {
