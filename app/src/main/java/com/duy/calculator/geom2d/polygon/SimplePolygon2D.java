...
import com.duy.calculator.geom2d.util.AffineTransform2D;
import com.duy.calculator.geom2d.GeometricObject2D;
import com.duy.calculator.geom2d.Point2D;
import com.duy.calculator.geom2d.line.LineSegment2D;
 ...
 */
public class SimplePolygon2D implements com.duy.calculator.geom2d.polygon.Polygon2D {
    ...
    public int getWindingNumber(double x, double y) {
        return com.duy.calculator.geom2d.polygon.Polygons2D.windingNumber(vertices, new Point2D(x, y));
    }
    ...
    public SimplePolygon2D simplify(double distMax) {
        return new SimplePolygon2D(com.duy.calculator.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
     ...
     */
    public double area() {
        return com.duy.calculator.geom2d.polygon.Polygons2D.computeArea(this);
    }
    ...
    public Point2D centroid() {
        return com.duy.calculator.geom2d.polygon.Polygons2D.computeCentroid(this);
    }
     ...
     */
    public com.duy.calculator.geom2d.polygon.Polygon2D asPolygon(int n) {
        return this;
    }
