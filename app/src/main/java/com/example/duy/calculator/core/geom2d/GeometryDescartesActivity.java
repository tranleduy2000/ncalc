...
package com.example.duy.calculator.core.geom2d;
...
import com.example.duy.calculator.core.geom2d.FragmentLine;
...
public class GeometryDescartesActivity extends AbstractNavDrawerActionBarActivity
    ...
    static class PagerApdater extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new com.example.duy.calculator.core.geom2d.FragmentVector();
                case 1:
