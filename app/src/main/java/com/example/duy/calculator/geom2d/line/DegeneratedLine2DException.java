...
public class DegeneratedLine2DException extends RuntimeException {
	...
	protected com.example.duy.calculator.geom2d.line.LinearShape2D line;
	
	/**
	 * @param msg the error message
	 * @param line the degenerated line
	 */
	public DegeneratedLine2DException(String msg, com.example.duy.calculator.geom2d.line.LinearShape2D line) {
		super(msg);
		this.line = line;
	}
	 ...
	 * @param line the degenerated line
	 */
	public DegeneratedLine2DException(com.example.duy.calculator.geom2d.line.LinearShape2D line) {
		super();
		this.line = line;
	}

	public com.example.duy.calculator.geom2d.line.LinearShape2D getLine() {
		return line;
	}
}
