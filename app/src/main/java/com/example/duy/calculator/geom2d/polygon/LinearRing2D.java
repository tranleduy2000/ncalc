...
public class LinearRing2D extends LinearCurve2D {
    ...
    public LinearRing2D simplify(double distMax) {
        return new LinearRing2D(com.example.duy.calculator.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
    ...
    public double windingAngle(Point2D point) {
        int wn = com.example.duy.calculator.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        return wn * 2 * Math.PI;
    }
    ...
    public boolean isInside(Point2D point) {
        ...
        int winding = com.example.duy.calculator.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        if (area > 0) {
            return winding == 1;
        } else {
            return winding == 0;
