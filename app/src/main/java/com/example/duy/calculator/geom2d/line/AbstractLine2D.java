...
public abstract class AbstractLine2D extends AbstractSmoothCurve2D
        implements com.example.duy.calculator.geom2d.line.LinearShape2D {
    /**
    ...
    public AbstractLine2D subCurve(double t0, double t1) {
        ...
        if (Double.isInfinite(t1)) {
            if (Double.isInfinite(t0))
                ...
                return new com.example.duy.calculator.geom2d.line.Ray2D(this.point(t0), this.direction());
        }

        if (Double.isInfinite(t0))
            return new InvertedRay2D(this.point(t1), this.direction());
        else
            return new com.example.duy.calculator.geom2d.line.LineSegment2D(this.point(t0), this.point(t1));
