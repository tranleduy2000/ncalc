 ...
 */
public class SimplePolygon2D implements com.example.duy.calculator.geom2d.polygon.Polygon2D {
    ...
    public int getWindingNumber(double x, double y) {
        return com.example.duy.calculator.geom2d.polygon.Polygons2D.windingNumber(vertices, new Point2D(x, y));
    }
    ...
    public SimplePolygon2D simplify(double distMax) {
        return new SimplePolygon2D(com.example.duy.calculator.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
     ...
     */
    public double area() {
        return com.example.duy.calculator.geom2d.polygon.Polygons2D.computeArea(this);
    }
    ...
    public Point2D centroid() {
        return com.example.duy.calculator.geom2d.polygon.Polygons2D.computeCentroid(this);
    }
     ...
     */
    public com.example.duy.calculator.geom2d.polygon.Polygon2D asPolygon(int n) {
        return this;
    }
