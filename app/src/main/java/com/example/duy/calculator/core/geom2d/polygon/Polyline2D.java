...
public class Polyline2D extends LinearCurve2D
{
    ...
    public Polyline2D simplify(double distMax) {
        return new Polyline2D(com.example.duy.calculator.core.geom2d.polygon.Polylines2D.simplifyPolyline(this.vertices, distMax));
    }
    ...
    public boolean isInside(Point2D pt) {
        if (new com.example.duy.calculator.core.geom2d.polygon.LinearRing2D(this.vertexArray()).isInside(pt))
            return true;
