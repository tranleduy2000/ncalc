 ...
 * @author dlegland
 */
public class MultiPolygon2D implements com.example.duy.calculator.geom2d.polygon.Polygon2D {
    ...
    public com.example.duy.calculator.geom2d.polygon.Polygon2D complement() {
