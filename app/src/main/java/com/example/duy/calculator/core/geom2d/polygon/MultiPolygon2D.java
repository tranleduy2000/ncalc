 ...
 * @author dlegland
 */
public class MultiPolygon2D implements com.example.duy.calculator.core.geom2d.polygon.Polygon2D {
    ...
    public com.example.duy.calculator.core.geom2d.polygon.Polygon2D complement() {
    ...
    public boolean contains(double x, double y) {
        return this.contains(new com.example.duy.calculator.core.geom2d.Point2D(x, y));
    }
