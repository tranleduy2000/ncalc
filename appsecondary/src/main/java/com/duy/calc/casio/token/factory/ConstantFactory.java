...
public class ConstantFactory {
    ...
    public static ConstantToken makeNewtonianOfGravity() {
    ...
    public static ConstantToken makeMolarGas() {
    ...
    public static ConstantToken makeExponent() {
        return new ConstantToken("Exponent", "e", "e", Math.E, "");
    }

    public static ConstantToken makeMounMass() {
        return new ConstantToken("Exponent", "e", "e", 1.883531594e-28, "");
    }
