    ...
    public void printTree(String indent, boolean last) {
        ...
        if (this.content instanceof Token) {
            if (this.content instanceof NumberToken) {
                if (((NumberToken) this.content).getDoubleValue() % 1 != 0) {
                    System.out.println(" " + ((NumberToken) this.content).getDoubleValue());
                } else {
                    System.out.println(" " + (int) (((NumberToken) this.content).getDoubleValue()));
                }
            } else {
