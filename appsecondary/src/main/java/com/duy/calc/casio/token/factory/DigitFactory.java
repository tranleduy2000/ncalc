...
public class DigitFactory {
    ...
    public static DigitToken makeA() {
        return new DigitToken("A", -2);
    }

    public static DigitToken makeB() {
        return new DigitToken("B", -3);
    }

    public static DigitToken makeC() {
        return new DigitToken("C", -4);
    }

    public static DigitToken makeD() {
        return new DigitToken("D", -5);
    }

    public static DigitToken makeE() {
        return new DigitToken("E", -6);
    }

    public static DigitToken makeF() {
        return new DigitToken("F", -7);
    }
