...
//        addParams("3x + 2y = 0");
    ...
    public class TaskSolveSystemEquations extends AsyncTask<Void, Void, String> {
        ...
        public TaskSolveSystemEquations(CalcApplication context) {
            this.evaluator = BigEvaluator.newInstance(context);
        ...
        protected String doInBackground(Void... voids) {
            ...
            Log.d(TAG, input);
            if (evaluator.isSyntaxError(input))
             ...
             */
            evaluator.setFraction(true);
            evaluator.evaluateWithResultAsTex(input, new LogicEvaluator.EvaluateCallback() {
                @Override
